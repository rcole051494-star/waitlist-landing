...
export const pythonLessons: Lesson[] = [
  {
    ...
    summary: 
      "Bind names to values. Learn Python's core types and modern f-string formatting.",
    ...
    steps: [
      {
        ...
        answer: "total: {qty * price}\ntotal: 12",
        reveal: 
          "Same line twice. The only difference is the `f` before the opening quote.\n\nWithout it, Python prints exactly the characters you typed, curly braces and all. With it, you get an **f-string**, and anything inside `{ }` is worked out and dropped into the text.\n\nThat `f` is the most-used piece of Python syntax you haven't met yet, and this lesson is where it lands.",
      },
      {
        kind: "read",
        id: "r1",
        ...
        items: [
          {
            text: "42",
            bucket: 0,
            why: "No decimal point and no quotes — a plain whole number.",
          },
          {
            text: "42.0",
            bucket: 1,
            why: 
              "The decimal point makes it a float, even though the value is a whole amount.",
          },
          {
            text: "'42'",
            bucket: 2,
            why: 
              "The quotes make it text. It looks like a number but you can't do maths on it.",
          },
          {
            text: "True",
            bucket: 3,
            why: "A bool. Capital T, no quotes — Python's built-in true value.",
          },
          {
            text: "'True'",
            bucket: 2,
            why: 
              "Quoted, so it's just the five characters T-r-u-e as text, not the boolean.",
          },
          {
            text: "-7",
            bucket: 0,
            why: "Negative numbers are still ints as long as there's no decimal point.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        intro: 
          "Python builds the finished string piece by piece. Here's what it's doing.",
        code: 
          "price = 4\n"
          + "qty = 3\n"
          + "print(f'{qty} items at ${price} = ${qty * price}')\n",
        lines: [
          { code: "price = 4", what: "Stick the value 4 onto the name price.", state: "price = 4" },
          { code: "qty = 3", what: "Stick the value 3 onto the name qty.", state: "price = 4, qty = 3" },
          {
      ...
      },
      {
        ...
        prompt: "This should print exactly: Ada scored 91.5%  — fill in the three gaps.",
        template: 
          "name = 'Ada'\n"
          + "score = 91.4567\n"
      ...
      },
      {
        ...
        why: 
          "f-strings with format specs are the current idiomatic choice — the value and its formatting live inline, where you can see them in context.",
      },
      {
        kind: "explain",
        id: "x1",
...

  {
    ...
    title: "Numbers & math",
    summary: 
      "int, float, arithmetic operators, integer vs true division, and the math module.",
    ...
    steps: [
      {
        ...
        reveal: 
          "Two surprises. The first isn't a Python bug — you'd get the same in JavaScript, Java and C. Computers store numbers in binary, and 0.1 has no exact binary form, the same way 1/3 has no exact decimal one.\n\nThe second is a Python speciality: `/` always gives a decimal, even for numbers that divide evenly, and `//` is the one that throws the remainder away.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        items: [
          {
            text: "average of two numbers",
            bucket: 0,
            why: "You want the exact fractional answer, so true division.",
          },
          {
            text: "how many whole boxes of 12",
            bucket: 1,
            why: "You want the whole count with the leftover discarded — floor division.",
          },
          {
            text: "is this number even?",
            bucket: 2,
            why: "Check the remainder after dividing by 2: n % 2 == 0.",
          },
          {
            text: "area of a square (side × side)",
            bucket: 3,
            why: "side ** 2 — squaring is raising to a power.",
          },
          {
            text: "leftover seconds after whole minutes",
            bucket: 2,
            why: "seconds % 60 gives exactly the remainder.",
          },
          {
            text: "split a bill exactly between 3 people",
            bucket: 0,
            why: "You want the precise share including pence, so true division.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "2 + 48",
            what: 
              "Addition last. The whole right side comes to 50, which then gets stuck onto the name total.",
            state: "total = 50",
            highlight: false,
          },
          {
            code: "print(total)",
            what: 
              "Shows the finished value. If you'd wanted the addition first you'd have written (2 + 3) * 4 ** 2 — brackets beat everything.",
            state: "total = 50",
            output: "50",
          },
        ],
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Modulo, and the two division signs",
        body: 
    ...
    steps: [
      {
        ...
        answer: "[  Ada  ]",
        reveal: 
          "`strip()` ran perfectly. It removed the spaces, built a clean new string — and threw it away.\n\nStrings in Python are **immutable**: nothing can change one in place. Every string method returns a *new* string and leaves the original alone.\n\nSo the fix is to catch what comes back: `name = name.strip()`. Every string method in this lesson behaves the same way.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "print(s[0])",
            what: 
              "A single position, not a slice — hand back just the character sitting at 0.",
            output: "c",
          },
          {
            code: "print(s[-1])",
      ...
      },
      {
        kind: "read",
        id: "r1b",
        title: "Positions, negatives and slicing",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r3b",
        title: "Reshaping: replace, split and join",
        body: 
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "Empty, but not equal",
        code: 
          "print(bool([]), bool([0]))\n"
          + "print([] == False)\n",
        answer: "False True\nFalse",
        reveal: 
          "An empty list is falsy. A list containing a zero is **truthy** — it has something in it, and Python doesn't care what.\n\nAnd yet `[] == False` is False, because `if x:` and `x == False` ask different questions. The first asks \"is this thing empty/zero/nothing?\"; the second asks \"is this thing the boolean False?\".\n\nThis lesson is about which values count as \"nothing\", and why you write `if items:` rather than comparing.",
      },
      {
        kind: "read",
        id: "r1",
        ...
        items: [
          {
            text: "0",
            bucket: 1,
            why: "Zero is falsy — the only number that is.",
          },
          {
            text: "'0'",
            bucket: 0,
            why: 
              "A string containing the character 0. It's not empty, so it's truthy — a classic trap when reading numbers from text input.",
          },
          { text: "''", bucket: 1, why: "The empty string is falsy." },
          {
            ...
            bucket: 0,
            why: 
              "A non-empty string. The contents are irrelevant — only emptiness matters.",
          },
          { text: "[]", bucket: 1, why: "An empty list is falsy." },
          {
            ...
            bucket: 0,
            why: 
              "A list with one item in it. The list isn't empty, so it's truthy, even though the item inside is falsy.",
          },
          { text: "None", bucket: 1, why: "None is always falsy." },
          {
            text: "-1",
            bucket: 0,
            why: "Every number except 0 is truthy, negatives included.",
          },
        ],
      },
      {
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Which values count as nothing",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r3b",
        title: "and / or hand back a value, not True",
        body: 
      ...
      },
      {
        ...
        expected: "hi Ada",
        hints: [
          "Run it. A name is definitely there, so why is it saying nobody home?",
          "`'Ada' == True` is False — comparing a string to True asks whether it IS the boolean True, not whether it has anything in it.",
          "Don't compare to True at all. Test the value itself: `if name:`",
        ],
        solution: 
          "name = 'Ada'\n"
          + "if name:\n"
          ...
          + "    print('nobody home')\n",
        solutionWhy: 
          "`if name:` asks the question you meant: does this have anything in it? Any non-empty string passes, and an empty one doesn't.\n\n`== True` is a different question, and it's almost never the one you want — it's only True for the boolean True itself. The same goes for `== False`; write `if not name:` instead.",
      },
      {
        kind: "write",
        id: "w1",
...

  {
    ...
    summary: 
      "Branching and looping with Python's block syntax; `break`, `continue`, `else` on loops.",
    concepts: ["py:if", "py:for", "py:while", "py:break-continue"],
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "Off by one, on purpose",
        code: 
          "print(list(range(3)))\n"
          + "print(list(range(1, 4)))\n",
        answer: "[0, 1, 2]\n[1, 2, 3]",
        reveal: 
          "`range(3)` gives you three numbers and 3 isn't one of them. `range(1, 4)` stops before 4.\n\nThe rule is consistent once you see it: **range stops before the number you give it.** It counts from the start, and the end is a boundary rather than a destination.\n\nIt looks like a trap and it's actually a convenience — `range(len(items))` lines up exactly with the valid indexes.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          {
            code: "total = 0",
            what: "Set up a running tally, starting at nothing.",
            state: "total = 0",
          },
          {
          ...
          },
          {
            code: "for i in range(1, 4):",
            what: 
              "There are more numbers to come, so i is re-pointed at 2 and the block runs again.",
            state: "i = 2, total = 1",
          },
          {
            code: "    total = total + i",
          ...
          },
          {
            code: "    total = total + i",
            what: 
              "i is now 3. total (3) plus 3 is 6. After this pass, range has run out of numbers.",
            state: "i = 3, total = 6",
          },
          {
            code: "print(total)",
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "range stops before the number you give it",
        body: 
      ...
      },
      {
        ...
        solution: ["for n in [3, 2, 1]:", "    print(n)", "print('liftoff')"],
        expectedOutput: "3\n2\n1\nliftoff",
        hints: [
      ...
      },
      {
        kind: "read",
        id: "r3b",
        title: "break, continue, and looping with an index",
        body: 
      ...
      },
      {
        ...
        prompt: 
          "Print the sum of every even number from 1 to 100 inclusive. Expected: 2550",
        starter: 
          "# print the sum here\n",
        expected: "2550",
        hints: [
      ...
      },
      {
        ...
        prompt: 
          "The third argument to range is the step — how much to count by each time.",
...

  {
    ...
    title: "Lists",
    summary: 
      "Ordered, mutable sequences. Common methods, aliasing pitfalls, and copies.",
    concepts: ["py:list", "py:aliasing", "py:list-methods"],
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "The backup that wasn't",
        code: 
          "a = [1, 2, 3]\n"
          + "b = a\n"
          + "a.append(4)\n"
        ...
        answer: "[1, 2, 3, 4]",
        reveal: 
          "`b` was never a copy. `b = a` copied the **arrow pointing at the list**, not the list — so both names refer to one list, and appending through either shows up in both.\n\nThis is the single biggest difference between lists and the strings and numbers you've used so far. Those can't change, so sharing them is harmless. A list can change under you.",
      },
      {
        kind: "read",
        id: "r1",
        ...
        items: [
          {
            text: "xs.append(4)",
            bucket: 0,
            why: "A method that adds to the list itself, and returns None.",
          },
          {
            text: "xs.sort()",
            bucket: 0,
            why: "Sorts in place and returns None — the list itself is reordered.",
          },
          {
            text: "sorted(xs)",
            bucket: 1,
            why: "A function that builds and returns a new sorted list; xs is untouched.",
          },
          { text: "xs.reverse()", bucket: 0, why: "Reverses in place, returns None." },
          {
            text: "xs[::-1]",
            bucket: 1,
            why: "A slice, and slicing always builds a new list.",
          },
          {
            text: "xs + [99]",
            bucket: 1,
            why: 
              "The + operator makes a new combined list rather than modifying either side.",
          },
          {
            text: "xs.pop()",
            bucket: 0,
            why: 
              "Removes the last item from the list AND returns that item — it does both.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "print(b)",
            what: 
              "Same object, so identical output. They aren't two lists that happen to match — they are one list.",
            output: "[1, 2, 3, 4]",
          },
        ],
        takeaway: 
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Methods that change it vs functions that don't",
        body: 
      ...
      },
      {
        ...
        prompt: 
          "Print a list of the squares of the odd numbers from 1 to 9 inclusive. Expected: [1, 9, 25, 49, 81]",
        starter: 
          "# print the list here\n",
    ...
    steps: [
      {
        ...
        answer: "2 1",
        reveal: 
          "In most languages swapping two variables needs a third one to hold the first value while you overwrite it. Python doesn't.\n\n`a, b = b, a` builds a **tuple** of the current values on the right first, and only then unpacks it into the names on the left. The old values are safely tucked away in that tuple while the assignment happens.\n\nTuples show up all over Python for exactly this: grouping a few values for a moment.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        kind: "read",
        id: "r1b",
        title: "What a tuple signals to a reader",
        body: 
      ...
      },
      {
        ...
        code: 
          ...
          + "print(a, b)\n",
        note: 
          "Try adding a third variable and rotating them: a, b, c = c, a, b. The same rule applies.",
      },
      {
        kind: "read",
        id: "r2",
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Unpacking, and the swap trick",
        body: 
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "In the order you put them",
        code: 
          "d = {}\n"
          + "d['b'] = 1\n"
          + "d['a'] = 2\n"
        ...
        answer: "['b', 'a']\n{'b': 3, 'a': 2}",
        reveal: 
          "Not sorted — and `'b'` is still first even though it was updated last.\n\nA dict remembers **insertion order**, and updating an existing key doesn't move it. That's guaranteed behaviour in modern Python, not luck.\n\nA dict is the workhorse of Python: any time you need to look something up by name rather than by position, this is the tool.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          {
            code: "counts = {}",
            what: "Start with an empty dict — no keys at all yet.",
            state: "counts = {}",
          },
          {
          ...
          },
          {
            code: "    counts[ch] = counts.get(ch, 0) + 1",
            what: 
              "Second pass, ch is 'a'. Same story: not present, so get returns 0, and 1 gets stored.",
      ...
      },
      {
        kind: "read",
        id: "r3b",
        title: "Looping over keys, values and both",
        body: 
    ...
    steps: [
      {
        ...
        answer: "3\ndict\nset",
        reveal: 
          "The duplicate silently vanished — that's a **set**, and it's exactly what you want for \"unique things\".\n\nBut `{}` on its own is an empty **dict**, not an empty set. Dicts got the curly braces first and kept them. The only way to write an empty set is `set()`.\n\nThat one catches everybody once.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        items: [
          {
            text: "keep items in the order added",
            bucket: 0,
            why: 
              "Lists preserve order and allow duplicates — the default choice for a sequence.",
          },
          {
            text: "look up a price by product name",
            bucket: 1,
            why: "That's a key-to-value mapping, which is exactly what a dict is for.",
          },
          {
            text: "check 'have I seen this id before?'",
            bucket: 2,
            why: "Fast membership testing with no duplicates — the classic set use.",
          },
          {
            text: "strip duplicates out of some data",
            bucket: 2,
            why: "Sets discard duplicates automatically by construction.",
          },
          {
            text: "count how often each word appears",
            bucket: 1,
            why: "You're mapping each word to a number, so a dict.",
          },
          {
            text: "store a to-do list in priority order",
            bucket: 0,
            why: "Order is the whole point, and duplicates are allowed.",
          },
        ],
      },
      {
        kind: "read",
        id: "r1b",
        title: "Why sets are fast, and the empty-set trap",
        body: 
      ...
      },
      {
        ...
        why: 
          "Intersection keeps only values found in both sets. 1 is only in the first, 4 only in the second, so 2 and 3 remain.",
      },
      {
        kind: "write",
        id: "w1",
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "A loop on one line",
        code: 
          "print([n * 2 for n in range(4) if n % 2 == 0])\n",
        answer: "[0, 4]",
        reveal: 
          "Four lines of loop, filter and append, compressed into one.\n\nRead it in the order it runs, not left to right: **take each `n` from range(4), keep the ones where `n % 2 == 0`, then double what's left.** So 0 and 2 survive, and become 0 and 4.\n\nThis is the most characteristically Python thing in the language, and once it clicks you'll write it constantly.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "    if n % 2 == 0:",
            what: 
              "The condition moves to the end, also unchanged apart from losing its colon.",
          ...
          },
          {
            ...
            what: 
              "The finished comprehension. Same loop, same condition, same appended value — rearranged.",
            state: "squares = [0, 4, 16]",
          },
        ],
        takeaway: 
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Dict, set and generator versions",
        body: 
      ...
      },
      {
        ...
        title: "Predict",
        code: 
          "print([x*x for x in range(1,6) if x % 2])\n",
        answer: "[1, 9, 25]",
        hints: [
      ...
      },
      {
        ...
        buggy: 
          "print({n: n*n for n in range(6) if n % 2})\n",
        ...
        solution: 
          "print({n: n*n for n in range(6) if n % 2 == 0})\n",
        solutionWhy: 
...

  {
    ...
    title: "Functions",
    summary: 
      "Definitions, defaults, *args, **kwargs, keyword-only, and the mutable-default trap.",
    ...
    steps: [
      {
        ...
        answer: "5\nNone",
        reveal: 
          "The 5 on screen came from inside the function. `result` got `None` — nothing.\n\n`print` puts characters on a screen for a human. `return` hands a value back to the code that called it. They look similar while you're testing and are completely different jobs.\n\nA function with no `return` gives back `None`, silently. This is the number one source of confusion when people start writing functions.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "print(x)",
            what: 
              "Shows 10. Note `result` and `n` no longer exist out here — they only lived inside the call.",
            state: "x = 10",
            output: "10",
          },
        ],
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "A function with no return gives back None",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r3b",
        title: "Keyword arguments, *args and **kwargs",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r4b",
        title: "Why the default list kept growing",
        body: 
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "Hints that don't enforce",
        code: 
        ...
        answer: "hello Ada",
        reveal: 
          "The hints say this takes an `int` and returns an `int`. It's handed a string, returns a string, and Python runs it without a murmur.\n\nType hints are **documentation that tools can read**. Python itself ignores them completely at runtime. Your editor and a checker like mypy are what turn them into real warnings.\n\nThat's not a weakness — it's the deal. You get the benefit where it helps and none of the ceremony where it doesn't.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        kind: "read",
        id: "r1b",
        title: "What hints actually buy you",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Optional values and type aliases",
        body: 
...

  {
    ...
    summary: 
      "Bundling data with behaviour; `__init__`, `self`, methods, and `@dataclass`.",
    concepts: ["py:classes", "py:oop", "py:dataclass"],
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "Two dogs, never equal",
        code: 
          "class Dog:\n"
        ...
        answer: "Rex Rex\nFalse",
        reveal: 
          "Same class, same name, and Python says they're different.\n\nBy default `==` on your own class asks **\"are these the same object in memory?\"** — not \"do they hold the same data\". Two separately created dogs are two objects, however identical they look.\n\nYou can change that, and this lesson shows the one-line way to get sensible equality (and a readable printout) for free.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "d = Dog('Rex')",
            what: 
              "__init__ returns nothing useful; Python hands back the finished instance, and d points at it.",
          ...
          },
          {
            ...
            what: 
              "self.name looks up the attribute stored earlier by __init__ — 'Rex'. The finished string goes back to print.",
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "@dataclass: equality and repr for free",
        body: 
...

  {
    ...
    summary: 
      "Catching what you expect, letting the rest surface, and raising your own.",
    ...
    steps: [
      {
        ...
        answer: "from finally",
        reveal: 
          "`return 'from try'` definitely ran. Its value was discarded on the way out.\n\n`finally` runs on **every** exit path, and a `return` inside it overrides whatever was already leaving — it would swallow an exception the same way.\n\nWhich is the rule: `finally` is for cleanup only. Never return from one.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          {
            code: "print(f())",
            what: "Evaluate f() first — execution jumps into the function.",
            state: "inside f",
          },
          {
            code: 
          ...
          },
          {
            code: "print(f())",
            what: 
              "Only now does f actually return the 1 it was holding, and the outer print shows it.",
            output: "1",
          },
        ],
        takeaway: 
      ...
      },
      {
        kind: "read",
        id: "r1b",
        title: "Capturing the error, else and finally",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Catch narrowly — the rule that matters most",
        body: 
...

  {
    ...
    summary: 
      "Producing values one at a time with `yield`, instead of building whole lists.",
    ...
    steps: [
      {
        ...
        answer: "[1, 2]\n[]",
        reveal: 
          "Same variable, same line, run twice — and the second time it's empty.\n\n`g()` doesn't hand back a list. It hands back a **generator**: something that produces values on demand and, once produced, has no way back. The first `list()` drained it.\n\nThat one-way behaviour is the price of the feature — being able to describe a sequence, even an endless one, without ever building it in memory.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            code: "next(g)  ->  n -= 1  /  loop  /  yield n",
            what: 
              "Same again: n becomes 1, yields 1, freezes. Note n survived between calls — the function's state was preserved, not rebuilt.",
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "Matching shapes, not values",
        code: 
          "point = (0, 5)\n"
          + "match point:\n"
          + "    case (0, 0):\n"
        ...
        answer: "on the y axis at 5",
        reveal: 
          "Look at what the second case did: it checked that the first value was 0, and in the same breath **pulled the second one out into `y`**.\n\nThat's the difference between `match` and a chain of `if`s. It isn't comparing values — it's checking the *shape* of the data and unpacking it at the same time.\n\nOnce you're dealing with nested data, this replaces a lot of fiddly index-checking.",
      },
      {
        kind: "read",
        id: "r1",
    ...
    steps: [
      {
        ...
        code: 
          ...
          + "print(Counter('bab').most_common(1))\n",
        answer: "4.0\n{\"a\": 1}\n[('b', 2)]",
        reveal: 
          "Three lines, three completely different jobs, nothing installed.\n\nPython ships with a large **standard library** — maths, JSON, dates, files, randomness, counting — and `import` is how you reach it. `Counter` there did in one line what would take a loop and a dict.\n\nKnowing what's already in the box is a genuine skill, and this lesson covers the parts worth knowing by name.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        kind: "read",
        id: "r1b",
        title: "import styles, and why not to use *",
        body: 
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "A function that didn't run",
        code: 
          "async def fetch():\n"
          + "    return 'data'\n"
          + "\n"
        ...
        answer: "coroutine\ndata",
        reveal: 
          "Calling `fetch()` didn't run the function. It built a **coroutine** — a description of work not yet started — and handed it over.\n\n`await` is what actually runs it and gets the value out.\n\nThat gap is the whole point: you can create a dozen of these, hand them all to the event loop, and have them run at the same time instead of one after another.",
      },
      {
        kind: "read",
        id: "r1",
    ...
    steps: [
      {
        ...
        code: 
          ...
          + "print(back['score'] + 1)\n",
        answer: "{\"name\": \"Ada\", \"score\": 10}\nstr\n11",
        reveal: 
          "The dict went in, and what came out is a **string** — not a dict that prints oddly, an actual piece of text.\n\nThat's the one idea behind saving anything: a file can only hold characters, so any structure you want to keep has to be flattened into text on the way out and rebuilt on the way back in.\n\n`json.dumps` flattens, `json.loads` rebuilds. This lesson is about doing that safely with real files.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        kind: "read",
        id: "r1b",
        title: "Modes, and why 'w' is dangerous",
        body: 
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "JSON: turning data into text and back",
        body: 
    ...
    steps: [
      {
        kind: "hook",
        id: "h1",
        title: "Assign and test at once",
        code: 
          "items = [1, 2, 3, 4, 5]\n"
          + "if (n := len(items)) > 3:\n"
          + "    print(f'{n} items — too many')\n",
        answer: "5 items — too many",
        reveal: 
          "`:=` — the walrus operator — does two things in one go: it puts `len(items)` into `n`, **and** hands the value to the `if`.\n\nWithout it you'd compute the length on one line and test it on the next, then have `n` hanging around whether you needed it or not.\n\nThis lesson is a tour of the recent additions like this one: small, sharp, and worth having in your hands.",
      },
      {
        kind: "read",
        id: "r1",
      ...
      },
      {
        kind: "read",
        id: "r2b",
        title: "Generic syntax, and except* for groups",
        body: 
