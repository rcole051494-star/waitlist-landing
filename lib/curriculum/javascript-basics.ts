...
export const javascriptBasicsLesson: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      lines: [
        ...
        },
        {
          ...
          what: "Line 1 is finished, so it moves to line 2. Same instruction, different text, shown on a new line below.",
          output: "step one\nstep two",
        },
        {
          code: "console.log('step three');",
          what: "Line 3. Shows the third piece of text. No more lines after this, so the program ends.",
          output: "step one\nstep two\nstep three",
        },
      ],
      takeaway:
    ...
    },
    {
      ...
      intro: "This is the line that confuses everyone at first. Step through it slowly.",
      code: "let score = 10;\nconsole.log(score);\nscore = score + 5;\nconsole.log(score);\n",
      lines: [
        {
          code: "let score = 10;",
    ...
    },
    {
      ...
      blanks: [
        { answer: "let", width: 4 },
        { answer: "console.log", accept: ["console.info"], width: 12 },
      ],
      explanation:
    ...
    },
    {
      ...
      solution: ["let name = 'Ada';", "let greeting = 'hello';", "console.log(greeting, name);"],
    ...
    },
    {
      ...
      why: "Quoted text shows as-is; an unquoted name gets looked up. console.log joins whatever you give it with single spaces, in order.",
    },
    {
      kind: "read",
      id: "r4",
