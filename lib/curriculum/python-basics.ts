  ...
  steps: [
    ...
    },
    {
      ...
      lines: [
        ...
        {
          code: "print(score)",
          what: "Looks up score again. It's 15 now, not 10 — the previous line replaced it.",
          state: "score = 15",
          output: "10\n15",
        },
      ],
    ...
    },
    {
      ...
      why: "Quoted text prints as-is; an unquoted name gets looked up. `print` joins whatever you give it with single spaces, in order.",
    },
    {
      kind: "read",
      id: "r4",
